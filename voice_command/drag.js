$(document).ready(function () {
        ...
        $('#btn1').click(function () {
            abortNewton();
            $('#inner').isotope({filter:'.gravity'});
        });
        $('#btn2').click(function () {
            abortNewton();
            $('#inner').isotope({ filter: '.client' });
        });
        $('#btn3').click(function () {
            abortNewton();
            $('#inner').isotope({ filter: '.win, .client, .open' });
        });
        $('#btn4').click(function () {
            abortNewton();
            $('#inner').isotope({ filter: '.ios, .client, .open' });
        });
        $('#btn5').click(function () {
            abortNewton();
            $('#inner').isotope({ filter: '.android, .client, .open' });
        });
        function abortNewton() {
            $("#inner").sortable('enable');
            $("#inner").css({ 'top': '50px', 'left': '0px', 'width': '350px', 'height': '500px' });
            runs = "stop";
            $('#bar').show(300);
            $(".steady").animate({
                left: '360px'
